...
export default function Dropdown() {
  ...
  return (
    <Select
      ...
      <MenuItem value="Recently Added" sx={{justifyContent: 'space-between'}}>
        Recently Added
        <Checkbox checked={sort === 'Recently Added'} />
      </MenuItem>
      <MenuItem value="Price:Low to height" sx={{justifyContent: 'space-between'}}>
        Price:Low to height
        <Checkbox checked={sort === 'Price:Low to height'} />
      </MenuItem>
      <MenuItem value="Price:High to Low" sx={{justifyContent: 'space-between'}}>
        Price:High to Low
        <Checkbox checked={sort === 'Price:High to Low'} />
      </MenuItem>
      <MenuItem value="Auction ending soon" sx={{justifyContent: 'space-between'}}>
        Auction ending soon
